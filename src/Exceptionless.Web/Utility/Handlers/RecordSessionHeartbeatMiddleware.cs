...
namespace Exceptionless.Web.Utility {
    public sealed class RecordSessionHeartbeatMiddleware {
        ...
        public async Task Invoke(HttpContext context) {
            ...
            if (AppConfiguration.Current.EventSubmissionDisabled || !context.Request.Query.TryGetValue("id", out var id) || String.IsNullOrEmpty(id)) {
            ...
            try {
                ...
                if (projectId != AppConfiguration.Current.InternalProjectId) {
