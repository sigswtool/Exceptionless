    ...
    public class SlackService {
        ...
        public async Task<SlackToken> GetAccessTokenAsync(string code) {
            ...
            var data = new Dictionary<string, string> {
                { "client_id", AppConfiguration.Current.SlackAppId },
                { "client_secret", AppConfiguration.Current.SlackAppSecret },
                { "code", code },
                { "redirect_uri", new Uri(AppConfiguration.Current.BaseURL).GetLeftPart(UriPartial.Authority) }
            };
