...
namespace Exceptionless.Core.Plugins.WebHook {
    ...
    public sealed class VersionOne : WebHookDataPluginBase {
        ...
        public class VersionOneWebHookEvent {
            ...
            public string Url => String.Concat(AppConfiguration.Current.BaseURL, "/event/", Id);
            ...
            public string ErrorStackUrl => String.Concat(AppConfiguration.Current.BaseURL, "/stack/", ErrorStackId);
        ...
        public class VersionOneWebHookStack {
            public string Id { get; set; }
            public string Url => String.Concat(AppConfiguration.Current.BaseURL, "/stack/", Id);
