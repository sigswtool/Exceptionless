...
namespace Exceptionless.Tests.Controllers {
    public class AuthControllerTests : TestWithServer {
        private readonly IUserRepository _userRepository;
        private readonly IOrganizationRepository _organizationRepository;
        private readonly IProjectRepository _projectRepository;
        private readonly ITokenRepository _tokenRepository;

        public AuthControllerTests(AppServerFixture appServerFixture, ServicesFixture fixture, ITestOutputHelper output) : base(appServerFixture, fixture, output) {
            Settings.EnableAccountCreation = true;
            Settings.EnableActiveDirectoryAuth = false;
        ...
        public async Task CannotSignupWhenAccountCreationDisabledWithNoTokenAsync(bool enableAdAuth, string email, string password) {
            ...
            Settings.EnableActiveDirectoryAuth = enableAdAuth;
        ...
        public async Task CanSignupWhenAccountCreationDisabledWithValidTokenAndInvalidAdAccountAsync() {
            Settings.EnableAccountCreation = false;
            Settings.EnableActiveDirectoryAuth = true;
